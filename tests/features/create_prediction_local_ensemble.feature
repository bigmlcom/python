Feature: Create Predictions locally from Ensembles
    ...
    Scenario: Successfully obtaining field importance from an Ensemble:
        ...
        | ../data/iris.csv | 10      | 10     |{"input_fields": ["000000", "000001","000003", "000004"]} |20      |{"input_fields": ["000000", "000001","000002", "000004"]} | 20     |{"input_fields": ["000000", "000001","000002", "000003", "000004"]} | 20   | 3 |[["000003", 0.59426], ["000002", 0.32209000000000004], ["000000", 0.04662333333333333], ["000001", 0.037026666666666666]]
