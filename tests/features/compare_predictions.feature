Feature: Compare Predictions
    ...
    Scenario: Successfully comparing predictions:
        ...
        | ../data/spam.csv | 20      | 20     | 30     | {"fields": {"000001": {"term_analysis": {"case_sensitive": false, "stem_words": false, "use_stopwords": false}}}} |{"Message": "Mobiles calls"}          | 000000    | ham    |
        ...
        | ../data/spam.csv | 20      | 20     | 30     | {"fields": {"000001": {"term_analysis": {"case_sensitive": false, "stem_words": true, "use_stopwords": true}}}} |{"Message": "Mobile call"}            | 000000    | ham    |
