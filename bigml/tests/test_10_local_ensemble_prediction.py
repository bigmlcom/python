...
class TestEnsemblePrediction(object):
    ...
    def test_scenario6(self):
        ...
        """
        examples = [
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "1910-05-08T19:10:23.106", "cat-0":"cat2"}', '000002', 1.25646],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "1920-06-30T20:21:20.320", "cat-0":"cat1"}', '000002', 0.9483],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "1932-01-30T19:24:11.450", "cat-0":"cat2"}', '000002',  -0.22173],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "1950-11-06T05:34:05.252", "cat-0":"cat1"}', '000002',  -0.8311],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "1969-7-14 17:36", "cat-0":"cat2"}', '000002', -0.00617],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "2001-01-05T23:04:04.693", "cat-0":"cat2"}', '000002',  -0.82588],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "2011-04-01T00:16:45.747", "cat-0":"cat2"}', '000002', 0.2546],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "1969-W29-1T17:36:39Z", "cat-0":"cat1"}', '000002',   -0.00617],
            ['data/dates2.csv', 10, 10, 50, '{"time-1": "Mon Jul 14 17:36 +0000 1969", "cat-0":"cat1"}', '000002', -0.00617]]
